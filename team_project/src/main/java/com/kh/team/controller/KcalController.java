...
public class KcalController {
	...
	// 운동칼로리 게시판
		...
		public String insertKcal(KcalVo kcalVo, RedirectAttributes rttr, MultipartFile file) {
			// 첨부 파일 확인
			System.out.println("kcalController, insertKcal, file:" + file);
			String originalFilename = file.getOriginalFilename();
			System.out.println("kcalController, insertKcal, originalFilename:" + originalFilename);
...
//			System.out.println("kcalController, listKcal, pagingDto:" + pagingDto);
...
//			System.out.println("listKcal:" + listKcal);
		...
		public String selectByKno(int kno, Model model, PagingDto pagingDto, HttpSession session) {
			System.out.println("kcalController, selectByKno, kno:" + kno);
		...
		public String updateKcal(KcalVo kcalVo, RedirectAttributes rttr, MultipartFile file, String prevImg) throws Exception{
			...
			return "redirect:/kcal/selectByKno?kno=" + kcalVo.getKno();
		}
