    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/recipe/imageUploader'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/recipe/do',	//샘플 URL입니다.
 	        sCallback : '/resources/static/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
